(function($) {
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<div class='mobile-menu-nav-back'> <h3 class='titlePortfolio'>QA Engineer PORTFOLIO</h3></div>"
    });
    ...
    $('.cart-items-area-light').on('click', function(e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response=='success') {
                            $this[0].reset();
                            $("#myModalSucessContact").modal('show');
                            setTimeout(function() {  $("#myModalSucessContact").modal('hide'); }, 3000);
                           
                            // $target.html("<div class='alert alert-success'><p>Message has been sent successfully.</p></div>");
                        } else {
                            $target.html("<div class='alert alert-danger'><p>Message has not been sent successfully. Please Submit it again</p></div>");
                        }
                    },
                    error: function() {
